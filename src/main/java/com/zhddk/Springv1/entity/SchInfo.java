...
public class SchInfo implements Serializable{
	...
	private String schpro;
	private String schbelong;
	...
	public String getSchpro() {
		return schpro;
	}
	public void setSchpro(String schpro) {
		this.schpro = schpro;
	}
	public String getSchbelong() {
		return schbelong;
	}
	public void setSchbelong(String schbelong) {
		this.schbelong = schbelong;
	}
	...
	public String toString() {
		return "SchInfo [schid=" + schid + ", schcode=" + schcode + ", schname=" + schname + ", schcity=" + schcity
				+ ", schpro=" + schpro + ", schbelong=" + schbelong + ", schlevel=" + schlevel + ", schlevelname="
				+ schlevelname + ", schtype=" + schtype + ", schtypename=" + schtypename + ", hot=" + hot + "]";
	}
